...
function data = ReadInData(datatype)
        ...
        %%%% GP DATA            
                    ...
                    headerformat = repmat('%s ', 1, 50);
                    readinformat = repmat('%s ', 1, 50);
                    readinformat(97:99) = '%f ';
                    readinformat(103:105) = '%f ';
